...
'''
ノイズ除去型autoencoder
入力データの一部を変更して、そこからもとのデータの特徴量を得らえるようにAutoEncoderにかける
->よりノイズののったデータから再構成する
Vincent, Pascal et al. "Extracting and Composeing Robust Features with Denoising Autoencoders"(2008)
Bengio Yoshua et al. "Generalized Denoising Auto-Encoders as Generative Models"(2013) 
'''
...
if __name__ == '__main__':
    ...
    with tf.Graph().as_default():
        with tf.variable_scope("autoencoder_model"):
            ...
            #corruptの値が1のとき、入力が改変され、そうでないときは改変されない
            ...
            for epoch in range(training_epochs):
                ...
                if epoch % display_step == 0:
                    ...
                    summary_writer.add_summary(train_summary,ess.run(global_step))
