...
'''
TF-Slim is a lightweight library for defining, 
training and evaluating complex models in TensorFlow. 
...
class PGAgent(object):
    ...
    def build_model(self):
        with tf.variable_scope("pg-model"):
            ...
            self.h0 = slim.fully_connected(self.state, self.hidden_size)  #input->layer1
            self.h1 = slim.fully_connected(self.h0, self.hidden_size) #layer1->layer2
            self.output = slim.fully_connected(self.h1,self.num_actions, activation_fn=tf.nn.softmax)#layer2->output
