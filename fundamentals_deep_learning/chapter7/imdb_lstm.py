...
#LSTM
'''
tensorflowのRNN用クラスとして次がある
単純なリカレント層:nn.rnn_cell.BasicRNNCell(   )
単純なLSTM:nn.rnn_cell.BasicLSTMCell(   )
GRUと呼ばれるLSTMの亜種:nn.rnn_cell.GRUCell(   )
設定を多くできるLSTM:nn.rnn_cell.LSTMCell(   )
'''
